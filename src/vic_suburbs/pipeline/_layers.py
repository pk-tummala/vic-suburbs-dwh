...
``01_bronze``, Silver tables/changes/crosswalk in ``02_silver``, and Gold dims+facts in
``03_gold``. Tables are defined and referenced by their fully-qualified name; the leading-digit
schema names are backtick-quoted.
"""
